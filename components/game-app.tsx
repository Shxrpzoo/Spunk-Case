  ...
  const sound = (win = false) => {
    ...
    try {
      ...
      for (let i = 0; i < (win ? 3 : 1); i++) {
        ...
        oscillator.frequency.value = (win ? 440 : 160) * [1, 1.25, 1.5][i];
        ...
        oscillator.stop(ctx.currentTime + i * 0.08 + 0.21);
      }
    } catch {}
  };
  ...
  async function recover() {
    ...
    try {
      ...
      if (pending.current) {
        ...
        const out = await api<Outcome>("play", pending.current);
        pending.current = null;
        sessionStorage.removeItem("spunk-pending");
        await refresh();
    ...
    <div className="app-shell">
      <header className="topbar">
        ...
        <div className="private-badge">
          THE FRIENDS CLUB <span>EST. 2026</span>
        </div>
      ...
      <footer>
        ...
        <p>
          For the friends. For the collection.
          <br />
          <span>
            Spunk Nuggets are fictional. No deposits, withdrawals, or cash
            value.
          </span>
        </p>
        <a href="/admin">
      ...
      {outcome && wonItem && (
        <div className="modal-backdrop">
          ...
          >
            ...
            >
              KEEP THE GOOD TIMES ROLLING <ArrowUpRight size={18} />
            </button>
          </section>
        </div>
      )}
